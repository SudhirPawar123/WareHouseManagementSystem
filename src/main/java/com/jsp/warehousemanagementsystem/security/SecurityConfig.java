package com.jsp.warehousemanagementsystem.security;
...
import com.jsp.warehousemanagementsystem.filters.ApiKeyFilter;
...
return httpSecurity.csrf(csrf -> csrf.disable())
		.securityMatchers(authorize ->authorize.requestMatchers("/api/v1/client/**") )
